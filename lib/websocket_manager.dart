...
class WebsocketManager {
  ...
  static Future<void> echoTest() async {
    final dynamic result = await _channel.invokeMethod<dynamic>(_METHOD_CHANNEL_TEST_ECHO);
    print(result);
  }
  ...
  Future<void> _create() async {
    ...
    // print(url);
    // print(header);
    await _channel.invokeMethod<dynamic>(_METHOD_CHANNEL_CREATE, <String, dynamic>{
      'url': url,
      'header': header,
    });
    _onMessage();
...
//    }
  ...
  void _onMessage() {
    if (_eventsMessage == null) {
      _eventsMessage = _eventChannelMessage.receiveBroadcastStream().asBroadcastStream();
